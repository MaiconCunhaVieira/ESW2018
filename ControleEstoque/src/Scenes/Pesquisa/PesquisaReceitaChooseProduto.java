...
import Scenes.Cadastro.WindowCadastro;
...
public class PesquisaReceitaChooseProduto extends WindowCadastro {
    ...
    public void ChangeScene(){
        ...
        button_ok.setOnAction(e -> {
            ...
            if(nomeProduto != null) {
                ...
                PesquisaReceitaShowTable pesqReceitaTable = new PesquisaReceitaShowTable(codProd);
                pesqReceitaTable.ChangeScene();
            }
        });
